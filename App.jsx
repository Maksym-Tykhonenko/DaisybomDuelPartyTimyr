...
import { OnboardingScreen1 } from './daisybom/daisybomScreens/OnboardingScreen1';
import { OnboardingScreen2 } from './daisybom/daisybomScreens/OnboardingScreen2';
import { OnboardingScreen3 } from './daisybom/daisybomScreens/OnboardingScreen3';
import { OnboardingScreen4 } from './daisybom/daisybomScreens/OnboardingScreen4';
import { MainTabs } from './daisybom/daisybomNavigation/MainTabs';
import { AddPlayerScreen } from './daisybom/daisybomScreens/AddPlayerScreen';
import { EditPlayerScreen } from './daisybom/daisybomScreens/EditPlayerScreen';
import { ChooseCategoryScreen } from './daisybom/daisybomScreens/ChooseCategoryScreen';
import { RoundScreen } from './daisybom/daisybomScreens/RoundScreen';
import { ResultsScreen } from './daisybom/daisybomScreens/ResultsScreen';
import { WishListScreen } from './daisybom/daisybomScreens/WishListScreen';
import { Colors } from './daisybom/daisybomConstants/colors';
import ProductScreen from './daisybom/daisybomScreens/ProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://clean-point-net.site/`;
  const URL_IDENTIFAIRE = `zPJVyDoE`;
  ...
  OneSignal.initialize('0f1e72ac-bd88-46a9-b360-2ab32f0d093d');
          ...
          <View style={{ flex: 1, overflow: 'hidden' }}>
            ...
            >
              <Image
                ...
                source={require('./daisybom/assets/img/1.png')}
                resizeMode="cover"
              />
              <Image
                style={{ width: screenWidth, height: '100%' }}
                source={require('./daisybom/assets/img/2.png')}
                resizeMode="cover"
              />
            </Animated.View>
          </View>
